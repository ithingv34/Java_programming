...
#### [1.변수와 타입]()
  - [O] [1-1.변수 선언](./Chapter1/README.md)
  - [O] [1-2.정수 타입](./Chapter_1/src/IntegerLiteral.java)
  - [O] [1-3.문자 타입](./Chapter_1/src/StringLiteral.java)
  - [O] [1-4.실수 타입](./Chapter_1/src/RealNumberLiteral.java)
  - [O] [1.5.문자열 타입](./Chapter_1/src/StringLiteral.java)
  - [O] [1.6.자동 타입 변환](./Chapter_1/src/AutoCasting.java)
  - [O] [1.7.강제 타입 변환](./Chapter_1/src/ForcedTypeConversion.java)
  - [O] [1.8.연산식에서 자동 타입 변환](./Chapter_1/README.md)
  - [O] [1.9.문자열을 기본 타입으로 변환](./Chapter_1/README.md)
  - [O] [1.10.콘솔로 변수 출력](./Chapter_1/src/ConsolePrint.java)
  - [O] [1.11.키보드 입력 데이터를 변수에 저장](./Chapter_1/src/ScannerVariable.java)
